...
use crate::bindings::{Guest, HighlightError, HtmlOutput, OwnedFrontmatter};
use crate::langs::{Lang, LANGS};
use crate::parser::{generate_toc, options, process_stream, process_stream_with_frontmatter, Toc};
use eyre::Result;
...
pub fn process_markdown_to_html(input: &str) -> std::result::Result<HtmlOutput, HighlightError> {
